...
//  stage.addChild(koordinatenachse);
  var createLabel = function(val, axis) {
    ...
    var skala = new PIXI.Text(val + " " + world.unit, {font: "bold 20px Tahoma" , fill: world.fontColor});
  ...
  var offset = {x: 1050, y: 2} //px von Rand;
...
Actor.prototype.resize = function(factor) {
